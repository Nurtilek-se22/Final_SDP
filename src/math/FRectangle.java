...
public class FRectangle implements HasRect<FRectangle> {
    ...
    public FRectangle(double x, double y, HasSize<?> size)      { this(x,        y,        s.getWidth(),    s.getHeight());    }
    ...
    public FRectangle(HasLocation<?> loc, double w, double h)   { this(p.getX(), p.getY(), w,               h);                }
    public FRectangle(HasLocation<?> loc, double s)             { this(p.getX(), p.getY(), s,               s);                }
